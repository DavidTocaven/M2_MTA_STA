...
I16  AI_9114_PreTrigConfig (U16 wCardNumber, U16 PreTrgEn, U16 TraceCnt);
...
I16  AI_AsyncDblBufferOverrun( U16 wCardNumber, U16 op, U16 *overrunFlag );
/*---------------------------------------------------------------------------*/
...
I16  AO_SimuWriteChannel (U16 wCardNumber, U16 wGroup, I16 *pwBuffer);
I16  AO_SimuVWriteChannel (U16 wCardNumber, U16 wGroup, F64 *pfBuffer);
...
I16  DI_ContMultiBufferReset( U16 wCardNumber );
...
I16  DI_AsyncDblBufferOverrun( U16 wCardNumber, U16 op, U16 *overrunFlag );
I16 DI_EventCallBack (U16 wCardNumber, I16 mode, I16 EventType, void (*callbackAddr)(int));
/*---------------------------------------------------------------------------*/
...
I16  DO_ContMultiBufferSetup (U16 wCardNumber, void *pwBuffer, U32 dwWriteCount, U16 *BufferId);
I16  DO_ContMultiBufferReset( U16 wCardNumber );
I16  DO_ContMultiBufferStart (U16 wCardNumber, U16 wPort, double fSampleRate);
I16  DO_AsyncMultiBufferNextReady (U16 wCardNumber, BOOLEAN *bNextReady, U16 *wBufferId);
...
/*---------------------------------------------------------------------------*/
I16 AI_GetView(U16 wCardNumber, U32 *pView);
I16 DI_GetView(U16 wCardNumber, U32 *pView);
I16 DO_GetView(U16 wCardNumber, U32 *pView);
I16 GetBaseAddr(U16 wCardNumber, U32 *BaseAddr, U32 *BaseAddr2);
I16 GetLCRAddr(U16 wCardNumber, U32 *LcrAddr);
